...
FilesInput = list()
FilesInput.append('../DatasetCovid/covid_qa_train.csv')

FileInputDocs = '../DatasetCovid/Articles.tsv'

FileOutputCSV = '../DatasetCovid/dataset_covid_qa_train.tsv'
FileOutputJson = '../DatasetCovid/dataset_covid_qa_train.json'
