...
def evaluate_with_instances(instances: Iterator[Instance], qa_pipeline: Pipeline,
...
def evaluate_with_all_annotated_instances(qa_pipeline: Pipeline, merge_all_texts: bool = False,
    ...
    return evaluate_with_instances(instances, qa_pipeline, sort_mode, batch_size, threads)
