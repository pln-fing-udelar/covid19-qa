...
class FrequentQuestionsApiView(APIView):
    def get(self, request):
        harcoded_response = [
            {
                ...
                "context": "Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto voluptas in itaque, debitis voluptatibus ab illum doloribus nemo sed vero optio veritatis repellat minima quae ex quo asperiores reiciendis reprehenderit.",
        ...
        return Response(harcoded_response)